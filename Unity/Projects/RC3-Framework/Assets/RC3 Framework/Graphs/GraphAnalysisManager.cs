...
namespace RC3.Graphs
{
    ...
    public class GraphAnalysisManager : MonoBehaviour
    {
        ...
        {
            _graphVisualizer.VizMode = VisualizerRenderMode.Components;
            _graphVisualizer.SetVizColors();
        }

        public void ShowDepth()
        {
            _graphVisualizer.VizMode = VisualizerRenderMode.DepthFromSource;
            _graphVisualizer.SetVizColors();
        }
        ...
        public void ShowComponentsSize()
        {
            ...
            _graphVisualizer.VizMode = VisualizerRenderMode.ComponentsSize;
            _graphVisualizer.SetVizColors();
        }

        public void ShowStress()
        {
            _graphVisualizer.VizMode = VisualizerRenderMode.ForceStressAnalysis;
            _graphVisualizer.SetVizColors();
        }
