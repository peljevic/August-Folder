...
namespace RC3.Graphs
{
    public class GraphVisualizer : MonoBehaviour
    {
        ...
        private VisualizerRenderMode _vizmode;
        ...
        {
            if (_vizmode == VisualizerRenderMode.ForceStressAnalysis)
            {
                StressForceRenderMode();
            }

            if (_vizmode == VisualizerRenderMode.DepthFromSource)
            {
                ChangeRenderMode(_sharedAnalysisGraph.NormalizedDepths);
            }

            if (_vizmode == VisualizerRenderMode.Components)
            {
                ChangeRenderMode(_sharedAnalysisGraph.NormalizedComponents);
            }

            if (_vizmode == VisualizerRenderMode.ComponentsSize)
            {
        ...
        */
        ...
        public VisualizerRenderMode VizMode
        {
            get { return _vizmode; }
            set { _vizmode = value; }
        }
